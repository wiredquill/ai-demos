...
![Version: 0.5.0](https://img.shields.io/badge/Version-0.5.0-informational?style=flat-square) ![AppVersion: 0.20250329.151219](https://img.shields.io/badge/AppVersion-0.20250329.151219-informational?style=flat-square)

Open WebUI Pipelines is UI-Agnostic OpenAI API Plugin Framework
...
| image.registry | string | `"dp.apps.rancher.io"` |  |
| image.repository | string | `"containers/open-webui-pipelines"` |  |
| image.tag | string | `"0.20250329.151219"` |  |
