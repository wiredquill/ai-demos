...
|------------|------|---------|
| oci://dp.apps.rancher.io/charts | tika(apache-tika) | 3.2.2 |
| oci://dp.apps.rancher.io/charts | ollama | 1.26.0 |
| oci://dp.apps.rancher.io/charts | pipelines(open-webui-pipelines) | 0.5.0 |
...
| image.tag | string | `"0.6.18"` | Image tag to use for the open-webui container |
...
| websocket.redis | object | `{"affinity":{},"annotations":{},"args":[],"command":[],"enabled":true,"image":{"pullPolicy":"IfNotPresent","registry":"dp.apps.rancher.io","repository":"containers/redis","tag":"8.0.2"},"labels":{},"name":"open-webui-redis","pods":{"annotations":{},"labels":{}},"resources":{},"securityContext":{},"service":{"annotations":{},"containerPort":6379,"labels":{},"nodePort":"","port":6379,"portName":"http","type":"ClusterIP"},"tolerations":[]}` | Deploys a redis |
...
| websocket.redis.image | object | `{"pullPolicy":"IfNotPresent","registry":"dp.apps.rancher.io","repository":"containers/redis","tag":"8.0.2"}` | Redis image |
...
| websocket.redis.image.tag | string | `"8.0.2"` | Image tag to use for the redis container |
